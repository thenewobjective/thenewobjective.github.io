...
&mdash; [Melvin E. Conway](https://en.wikipedia.org/wiki/Melvin_Conway)

More simply as:

> The structure of any system designed by an organization is isomorphic to the structure of the organization.

&mdash; [Edward Yourdon](https://en.wikipedia.org/wiki/Edward_Yourdon); [Larry L. Constantine](https://en.wikipedia.org/wiki/Larry_Constantine)
...
&mdash; Frederick P. Brooks Jr., The Mythical Man-Month: Essays on Software Engineering
...
&mdash; [Gall, John. Systemantics](https://en.wikipedia.org/wiki/Systemantics). Chapter 10

> Men have become the tools of their tools

&mdash; [Walden](https://en.wikiquote.org/wiki/Walden) by [Henry David Thoreau](https://en.wikiquote.org/wiki/Henry_David_Thoreau)

> It is easier to change the specification to fit the program than vice versa

&mdash; [Perlisism #57](http://www.cs.yale.edu/homes/perlis-alan/quotes.html) by [Alan Perlis](https://en.wikipedia.org/wiki/Alan_Perlis)
...
![Star Graph](/media-library/software-systems-engineering/star-graph.png "Star Graph")
...
![Banana Tree (Graph)](/media-library/software-systems-engineering/banana-tree.png "[Banana Tree (Graph)](https://mathworld.wolfram.com/BananaTree.html)")
...
![Banana Tree + Complete Graph Edges](/media-library/software-systems-engineering/banana-tree-and-complete.png "Banana Graph + Complete Graph Edges")
...
&mdash; The Fundamental Theorem of Software Engineering
...
![Distance Communication across graph](/media-library/software-systems-engineering/banana-tree-and-complete-cross-talk.png "Distant Communication")
...
&mdash; [John M. Culkin](https://en.wikipedia.org/wiki/John_M._Culkin)

A parting cartoon by [Manu Cornet](https://en.wikipedia.org/wiki/Manu_Cornet):

![Org charts by Manu Cornet](/media-library/software-systems-engineering/org-charts-manu-cornet.png "Org charts - [Manu Cornet](https://en.wikipedia.org/wiki/Manu_Cornet)")
